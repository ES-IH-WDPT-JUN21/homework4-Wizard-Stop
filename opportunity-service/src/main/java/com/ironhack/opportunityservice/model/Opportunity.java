...
public class Opportunity {
        ...
        public Opportunity(Product product, int quantity, Long decisionMakerId, Status status, Long salesRepId, Long accountId) {
            this.product = product;
            this.quantity = quantity;
            this.decisionMakerId = decisionMakerId;
            this.status = status;
        ...
        public Opportunity(Product product, int quantity, Long decisionMakerId, Long salesRepId) {
            this.product = product;
            this.quantity = quantity;
            this.decisionMakerId = decisionMakerId;
            this.salesRepId = salesRepId;
