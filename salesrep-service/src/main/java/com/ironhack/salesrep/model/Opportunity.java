...
public class Opportunity {
    ...
    public Opportunity(Product product, int quantity, Long decisionMaker) {
    ...
    public Opportunity(Product product, int quantity, Long decisionMaker, Status status, SalesRep salesRep) {
        this.product = product;
        this.quantity = quantity;
        this.decisionMaker = decisionMaker;
        this.status = status;
    ...
    public Opportunity(Product product, int quantity, Long decisionMaker, SalesRep salesRep) {
        this.product = product;
        this.quantity = quantity;
        this.decisionMaker = decisionMaker;
        this.salesRep = salesRep;
